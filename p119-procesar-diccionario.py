...
print('\033[H\033[J')
print("Diccionario de Nómina de Empleados\n")
...
# Crear el diccionario combinando ambas listas
...
# ------------------------------------------------
# ACCESAR VALORES USANDO LA LLAVE
# ------------------------------------------------
print("--- Llave y Valor (accediendo por llave) ---")
for empleado in nomina:
    print(empleado, "->", nomina[empleado])
print()

# ------------------------------------------------
# MOSTRAR ITEMS (LLAVE, VALOR)
# ------------------------------------------------
print("--- Llave y Valor (items) ---")
for par in nomina.items():
    print(par)
print()
...
# ------------------------------------------------
suma_sueldos = 0
for monto in nomina.values():
    suma_sueldos += monto

promedio = suma_sueldos / len(nomina)

print("--- Cálculos ---")
print("Suma total de sueldos:", f"{suma_sueldos:.2f}")
print("Promedio de sueldos:", f"{promedio:.2f}")
